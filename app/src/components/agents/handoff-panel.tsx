  ...
  return (
    <section className="mt-6 grid gap-2">
      ...
      <p className="text-muted-foreground text-sm">
        {enabled
          ? "Галочка разрешает передачу, но не запускает её автоматически. В диалоге выберите коллегу через @ или прямо попросите сотрудника передать работу. Ответ появится в отдельном диалоге выбранного коллеги."
